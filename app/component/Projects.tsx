...
export const Projects = () => {
  ...
  const projects = [
    ...
    { title: "devStuff", video: "/home/yum-video.mp4", link: "devstuff" },
    { title: "Yum", video: "/home/zoee-video.mp4", link: "yum" },
    { title: "I choose you", video: "/home/yum-video.mp4", link: "/zoee" },
    { title: "Other", video: "/home/zoee-video.mp4", link: "/zoee" },
    { title: "Yum", video: "/home/yum-video.mp4", link: "/zoee" },
  ];
      ...
      >
        {projects.map((project, index) => (
          <Link href={`/${project.link}`} key={index}>
            <div className="relative flex items-end justify-center bg-elegantPink h-72 w-72 md:h-96 md:w-96">
              <video
                autoPlay
                playsInline
                loop
